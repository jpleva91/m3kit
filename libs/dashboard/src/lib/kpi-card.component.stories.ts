  ...
  render: () => ({
    template: `
      <div style="display: flex; gap: 1rem;">
        <m3k-kpi-card label="Total revenue" [value]="1284902.44" format="currency" [delta]="4.2" cornerAccent="positive" />
        <m3k-kpi-card label="Overdue" [value]="12" format="number" [delta]="-3" cornerAccent="negative" />
        <m3k-kpi-card label="Open invoices" [value]="38" format="number" [delta]="6" cornerAccent="neutral" />
      </div>
    `,
  }),
};
