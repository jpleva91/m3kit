...
export const Default: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <rpt-chart-card [title]="title" [subtitle]="subtitle">
        <rpt-line-chart [series]="series" [area]="true" ariaLabel="Revenue by month" />
      </rpt-chart-card>
    `,
  }),
};
...
export const WithLegend: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <rpt-chart-card [title]="title" [subtitle]="subtitle">
        <rpt-line-chart [series]="series" ariaLabel="Revenue and costs by month" />
