...
- `src/reporting-theme/_contract.scss` — the component-facing custom-prop
...
- `src/reporting-theme/themes/instruments/` — "Instruments", the default
...
```scss
@use 'reporting-theme' as contract;            // the contract + helpers
